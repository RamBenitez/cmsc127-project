...
CREATE OR REPLACE TABLE Food_Establishment (
...
CREATE OR REPLACE TABLE Food_Establishment_Rating (
...
CREATE OR REPLACE TABLE Food_Review (
    ...
    CONSTRAINT Food_Review_Food_id_fk 
        FOREIGN KEY(Food_id) REFERENCES Food_Item(Food_id),
